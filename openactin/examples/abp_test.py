...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        try:
            ...
            pass
    sjob = openactin.SlurmJobArray("Simulations/SingleABP/SingleABP", parameters, test_parameters, job_id)
    ...
    model = openactin.Scene(model[(model['resName'] != abp) | (model['chainID'] == 'B')])
